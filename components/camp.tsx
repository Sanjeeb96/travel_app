      ...
      >
        ...
        <div className="flex items-center justify-center gap-4">
          ...
          <div className="flex flex-col gap-1">
            ...
            <p className="text-[14px] font-[500] text-white">{subtitle}</p>
          </div>
        </div>

        {/* Circle image components */}
      ...
      <div className="flex items-center justify-end mt-10 px-6 lg:-mt-60 lg:mr-6">
        ...
        >
          ...
          <Image
            ...
            width={186}
            height={219}
            className="absolute -right-6 bottom-4 w-[140px] lg:bottom-10 xl:-right-8
                       xl:w-[186px] 3xl:right-0"
          />
        </div>
      </div>
    </section>
