...
const Guide = () => {
  return (
    <section className="flex items-center justify-center flex-col">
      ...
      <div
        className="flex items-center justify-center mx-auto max-w-[1440px] 
                   relative w-full"
      >
        <Image
          src="/boat.png"
        ...
        >
          ...
          <div className="flex items-center justify-between flex-col">
            ...
            <div className="flex w-full flex-col">
              ...
              <p className="text-[20px] font-[700] mt-2">Mount kalimanjaro</p>
            </div>
            ...
            <div className="flex w-full flex-col">
              ...
              <p className="text-[20px] font-[700] mt-2 whitespace-nowrap">
                Korakoram Range
              </p>
            </div>
          </div>
